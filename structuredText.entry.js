...
module.exports = {
	danish: __webpack_require__(29).stopwords,
	dutch: __webpack_require__(36).stopwords,
	english: __webpack_require__(31).stopwords,
	french: __webpack_require__(33).stopwords,
	galician: __webpack_require__(34).stopwords,
	german: __webpack_require__(30).stopwords,
	italian: __webpack_require__(35).stopwords,
	polish: __webpack_require__(37).stopwords,
	portuguese: __webpack_require__(38).stopwords,
	russian: __webpack_require__(39).stopwords,
	spanish: __webpack_require__(32).stopwords,
	swedish: __webpack_require__(40).stopwords
};
...
var keyword_extractor = __webpack_require__(27);
var tmpSplitText = [];
var splitText = [];
var extractList = [];
var limit;
...
var Reset = function (_React$Component3) {
	_inherits(Reset, _React$Component3);
	...
	_createClass(Reset, [{
		...
		value: function render() {
			return React.createElement(
				'form',
				{ onSubmit: this.setState({ items: [], text: '', isLimit: '' }) },
				React.createElement(
					'button',
					null,
