...
var ExportList = function (_React$Component2) {
	...
	_createClass(ExportList, [{
		key: 'render',
		value: function render() {
			var keyword_extractor = __webpack_require__(2);
			...
			if (dataStoreController == true && catalogueService == true && PID == true) {
				...
				window.init({ "class": "go.GraphLinksModel",
					...
					"nodeDataArray": [{ "key": 1, "name": "Catalogue Service", "loc": "300 104",
						...
						"bottomArray": [],
						"rightArray": [] }],
					"linkDataArray": [{ "from": 1, "to": 2, "fromPort": "left0", "toPort": "right0" }, { "from": 1, "to": 3, "fromPort": "bottom0", "toPort": "top0" }, { "from": 2, "to": 3, "fromPort": "bottom1", "toPort": "left1" }, { "from": 5, "to": 2, "fromPort": "top0", "toPort": "bottom0" }, { "from": 3, "to": 2, "fromPort": "left0", "toPort": "right1" }, { "from": 4, "to": 2, "fromPort": "bottom0", "toPort": "top0" }] });
			}
			...
			// Collect Data 
					...
					window.init({ "class": "go.GraphLinksModel",
						...
						"nodeDataArray": [{ "key": 1, "name": "Field Laboratory", "loc": "030 050",
							...
							"bottomArray": [],
							"rightArray": [] }],
						"linkDataArray": [{ "from": 1, "to": 3, "fromPort": "top0", "toPort": "top0" }, { "from": 1, "to": 2, "fromPort": "bottom0", "toPort": "top0" }, { "from": 1, "to": 3, "fromPort": "right0", "toPort": "left0" }, { "from": 2, "to": 3, "fromPort": "right0", "toPort": "bottom0" }, { "from": 2, "to": 5, "fromPort": "right1", "toPort": "left0" }, { "from": 3, "to": 4, "fromPort": "right1", "toPort": "left1" }, { "from": 4, "to": 3, "fromPort": "left0", "toPort": "right0" }, { "from": 5, "to": 4, "fromPort": "top0", "toPort": "bottom0" }] });
				} else {
...
var _inputText = __webpack_require__(0);
...
module.exports = {
	danish: __webpack_require__(4).stopwords,
	dutch: __webpack_require__(11).stopwords,
	english: __webpack_require__(6).stopwords,
	french: __webpack_require__(8).stopwords,
	galician: __webpack_require__(9).stopwords,
	german: __webpack_require__(5).stopwords,
	italian: __webpack_require__(10).stopwords,
	polish: __webpack_require__(12).stopwords,
	portuguese: __webpack_require__(13).stopwords,
	russian: __webpack_require__(14).stopwords,
	spanish: __webpack_require__(7).stopwords,
	swedish: __webpack_require__(15).stopwords
};
